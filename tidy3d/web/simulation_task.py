...
class SimulationTask(ResourceLifecycle, Submittable, extra=Extra.allow):
    ...
    def get_simulation_json(self, to_file: str, verbose: bool = True) -> pathlib.Path:
        ...
        if os.path.exists(SIM_FILE_HDF5):
            ...
            with open(to_file, "w") as file:
                ...
                if verbose:
                    print("generate simulation.json successfully.")
        else:
            print("Failed to download simulation.json")
    ...
    def get_simulation_hdf5(
        ...
        if os.path.exists(SIM_FILE_HDF5_GZ):
            ...
            if verbose:
                print(f"extract {SIM_FILE_HDF5_GZ} to {to_file} successfully.")
        else:
            print("failed to download simulation.hdf5")
